    ...
    <div class="col-12">
        ...
        <div class="tab-content" id="configTabsContent">
            ...
            <div class="tab-pane fade" id="acs-config" role="tabpanel">
                <div class="card mt-3">
                    <div class="card-header">
                        <i class="bi bi-hdd-network"></i> GenieACS Configuration
            ...
            <div class="tab-pane fade" id="mikrotik-config" role="tabpanel">
                <div class="card mt-3">
                    <div class="card-header">
                        <i class="bi bi-ethernet"></i> MikroTik Configuration
            ...
            <div class="tab-pane fade" id="bot-config" role="tabpanel">
                <div class="card mt-3">
                    <div class="card-header">
                        <i class="fab fa-telegram"></i> Telegram Bot Configuration
                    ...
                    <div class="card-body">
                        <form id="form-telegram">
                            <div class="form-group">
                                ...
                                <small class="text-muted">Get from @BotFather</small>
                            </div>
                            <div class="form-group">
                                <label>Chat ID</label>
                                ...
                                <small class="text-muted">Get from @userinfobot</small>
                            </div>
                            <button type="submit" class="btn btn-success me-2">
                                <i class="bi bi-check-circle"></i> Test Connection
                            </button>
